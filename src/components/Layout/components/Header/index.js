      ...
      <header className={cx('wrapper')}>
         <div className={cx('inner')}>
            ...
            <div className={cx('actions')}>
               {currentUser ? (
                  <>
                     <HeadlessTippy placement="bottom" content="Đăng tải video">
                        <button className={cx('actions-btn')}>
                           <FontAwesomeIcon icon={faCloudUpload} />
                        </button>
                     </HeadlessTippy>
                     <HeadlessTippy placement="bottom" content="Tin nhắn">
                        <button className={cx('actions-btn')}>
               ...
               <Menu items={MENU_ITEMS} onChange={handleMenuChange}>
                  {currentUser ? (
                     <img
                        ...
                        src="https://images.pexels.com/photos/60597/dahlia-red-blossom-bloom-60597.jpeg?auto=compress&cs=tinysrgb&w=400"
                        alt="nguyana"
                     />
                  ) : (
                     <>
